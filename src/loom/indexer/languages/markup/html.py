"""html.py — HTML/Angular/Vue/Jinja2 template parser.
...
from loom.graph.content_hash import content_hash_bytes, content_hash_for_line_span
...
def _collect_form_inputs(element: TSNode, src: bytes) -> list[str]:
    return _collect_form_inputs_raw(element, src, _FORM_INPUT_TAGS)
